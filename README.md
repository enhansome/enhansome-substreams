...
* [Substreams Ethereum](https://github.com/streamingfast/substreams-ethereum) ⭐ 23 | 🐛 9 | 🌐 Rust | 📅 2026-09-11 - Substreams development kit for Ethereum chains, contains Firehose Block model and helpers as well as utilities for Ethereum ABI encoding/decoding.
...
* [​​Aptos](https://aptoslabs.com/) - [`aptos.extractor.v1.Block`](https://github.com/aptos-labs/aptos-core/blob/main/crates/aptos-protos/proto/aptos/extractor/v1/extractor.proto) ⭐ 6,431 | 🐛 548 | 🌐 Rust | 📅 2026-09-14
